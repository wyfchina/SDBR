...
from sdbr.ddmrp_replenishment import (
    ...
    canonical_fingerprint as ddmrp_canonical_fingerprint,
...
def create_app(
    ...
    *,
    ...
    async def persist_successful_writes(request, call_next):
        ...
        async with active_store.state_admission():
            ...
            try:
                ...
                skip_persistence = any(
                    (
                        getattr(
                            request.state, "skip_workbench_persistence", False
                        ),
                        getattr(request.state, "skip_workbench_save", False),
                    )
                )
    ...
    def planner_workbench_ddmrp_evaluations_create(
        ...
        try:
            request_fingerprint = ddmrp_canonical_fingerprint(
                {
